...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ishas\\OneDrive\\Desktop\\Lab in Psych\\solo project\\solo_project_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text="Hello! \n\nDuring the experiment, you will be presented with a text string at the center of your screen. Your task is to identify and decide whether the text is a word or a nonword as quickly and accurately as possible.\n\nPress 'y' for word, and 'n' for nonword. ",
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('list_4_vvtl.xlsx'),
