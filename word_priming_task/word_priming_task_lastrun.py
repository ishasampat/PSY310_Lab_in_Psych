...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ishas\\OneDrive\\Desktop\\Lab in Psych\\word_priming_task\\word_priming_task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/ishas/OneDrive/Desktop/Lab in Psych/word_priming_task/study_words.xlsx'),
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('C:/Users/ishas/OneDrive/Desktop/Lab in Psych/word_priming_task/test_words.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        test_phaseComponents = [text_2, textbox, text_3, mouse]
