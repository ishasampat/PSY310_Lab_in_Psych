...
expName = 'adaptive_staircase_exp'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ishas\\OneDrive\\Desktop\\Lab in Psych\\adaptive_staircase_exp\\adaptive_staircase_exp_lastrun.py',
