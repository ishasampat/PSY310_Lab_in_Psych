...
expName = 'motor_sequence_learning_exp'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ishas\\OneDrive\\Desktop\\Lab in Psych\\motor_sequence_learning_exp\\motor_sequence_learning_exp_lastrun.py',
